...
mix <- load_mix_data(filename="data/contemp_turtles_Oahu_consumer.csv",
...
source <- load_source_data(filename="data/contemp_turtles_Oahu_sources.csv",
                           source_factors=NULL,
                           conc_dep=TRUE,
                           data_type="means",
                           mix)
...
discr <- load_discr_data(filename="data/contemp_turtles_Oahu_discrimination.csv", mix)

# Plot isospace

plot_data(filename="results/CNS/contemp_turtles_Oahu_isospace_plot",
...
output_options <- list(summary_save = TRUE,
                       summary_name = "results/CNS/contemp_turtles_Oahu_summary_statistics_uninf", # 
                       sup_post = FALSE,
                       plot_post_save_pdf = TRUE,
                       plot_post_name = "results/CNS/contemp_turtles_Oahu_posterior_density_uninf", # 
                       sup_pairs = FALSE,
                       plot_pairs_save_pdf = TRUE,
                       plot_pairs_name = "results/CNS/contemp_turtles_Oahu_pairs_plot_uninf", # 
                       sup_xy = TRUE,
                       plot_xy_save_pdf = TRUE,
                       plot_xy_name = "results/CNS/contemp_turtles_Oahu_xy_plot_uninf", # 
                       gelman = TRUE,
                       heidel = TRUE,
                       geweke = TRUE,
                       diag_save = TRUE,
                       diag_name = "results/CNS/contemp_turtles_Oahu_diag_uninf",
                       indiv_effect = FALSE,
...
plot_prior(alpha.prior=1, source=source, plot_save_pdf=TRUE, plot_save_png=TRUE,filename = "results/CNS/contemp_turtles_Oahu_prior_plot_kw_uninf") # saves it as pdf

# Define model structure and write JAGS model file
model_filename <- "results/CNS/contemp_turtles_Oahu_MixSIAR_model_kw_uninf.txt"   # Name of the JAGS model file
resid_err <- TRUE
process_err <- TRUE
...
# # Output options for the plots:
# output_options <- list(summary_save = TRUE,
#                        summary_name = "results/CNS/contemp_turtles_Oahu_summary_statisticsf", #
#                        sup_post = FALSE,
#                        plot_post_save_pdf = TRUE,
#                        plot_post_name = "results/CNS/contemp_turtles_Oahu_posterior_density", #
#                        sup_pairs = FALSE,
#                        plot_pairs_save_pdf = TRUE,
#                        plot_pairs_name = "results/CNS/contemp_turtles_Oahu_pairs_plot", #
#                        sup_xy = TRUE,
#                        plot_xy_save_pdf = TRUE,
#                        plot_xy_name = "results/CNS/contemp_turtles_Oahu_xy_plot", #
#                        gelman = TRUE,
#                        heidel = TRUE,
#                        geweke = TRUE,
#                        diag_save = TRUE,
#                        diag_name = "results/CNS/contemp_turtles_Oahu_diag",
#                        indiv_effect = FALSE,
#                        plot_post_save_png = TRUE,
#                        plot_pairs_save_png = TRUE,
#                        plot_xy_save_png = TRUE,
...
# par(mar=c(1,1,1,1)) # margins size
# plot_prior(alpha.prior=kw.alpha, source=source, plot_save_pdf=TRUE, plot_save_png=TRUE,filename = "results/CNS/contemp_turtles_Oahu_prior_plot_kw") # saves it as pdf
# 
# # Define model structure and write JAGS model file
# model_filename <- "results/CNS/contemp_turtles_Oahu_MixSIAR_model_kw.txt"   # Name of the JAGS model file
# resid_err <- TRUE
# process_err <- TRUE
# write_JAGS_model(model_filename, resid_err, process_err, mix, source)
# 
